...
export default function HeroSection() {
  return (
    <section className="relative ">
      ...
      <StarCanvas />
      <div className="grid grid-cols-l sm:grid-cols-12 my-8">
        <div className="col-span-7 place-self-center sm:text-left mt-20">
          ...
          <p
            ...
            className="text-[#a0d4f5] custom-small-text  sm:text-lg mb-3 lg:text-xl"
          >
            Software Engineer experienced in scalable backend and full-stack
            systems
          </p>
          <p
            style={{ color: "#a0d4f5", fontSize: "14px", marginTop: "0.5rem" }}
            className="text-[#add8f3] text-sm  sm:text-lg mb-4 lg:text-xl"
          >
