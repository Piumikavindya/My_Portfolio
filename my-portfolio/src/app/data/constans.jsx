...
export const skills = [
  ...
  },
  {
    title: "DevOps & Tools",
    skills: [
      { name: "Git", image: "https://www.vectorlogo.zone/logos/git/git.svg" },
      {
        name: "GitHub Actions",
        image: "https://cdn.simpleicons.org/githubactions/181717",
      },
      {
        name: "Azure DevOps",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/0/04/Azure_Database_for_MySQL_logo.svg",
      },
      {
        name: "Docker",
        image:
      ...
      { name: "Jest", image: "https://jestjs.io/img/favicon/favicon.ico" },
    ],
  },
  {
    title: "Cloud & Other",
    skills: [
      ...
      },
      {
        name: "Jira",
        image:
          "https://wac-cdn.atlassian.com/dam/jcr:5d8f2b6e-0f04-4d7f-96c2-29f0f0f70d2e/Jira%20Software-white.svg",
      },
      { name: "MVC", image: "https://img.icons8.com/fluency/48/code.png" },
      {
        name: "Microservices",
        image: "https://img.icons8.com/fluency/48/network.png",
      },
    ],
  },
];
...
export const experiences = [
  {
    ...
    skills: ["C#", ".NET", "SQL Server", "React", "RabbitMQ", "Redis"],
  },
  {
    id: 1,
    ...
    desc: "Developed and optimized accounting, sales, and financial workflows in production environments processing LKR 500M+ monthly transactions. Implemented reporting and reconciliation modules, multi-stage approvals, and supported deployments, testing, and post-release fixes.",
    skills: [
      ".NET",
      "React",
      "SQL Server",
...
export const achievements = [
  ...
  {
    id: 3,
    title: "PMS selected among Top 7 projects",
    desc: "Procurement Management System selected as one of the top 7 projects in the Faculty of Engineering, University of Ruhuna.",
    link: "#",
  },
];
...
export const projects = [
  ...
  {
    id: 3,
    title: "Travel Planning Web Application",
  ...
  },
  {
    ...
    category: "ai",
    github: "https://github.com/DepressionDetector",
    webapp: "https://github.com/DepressionDetector",
  },
  {
    id: 5,
    title: "Home Appliances Energy Consumption Prediction",
